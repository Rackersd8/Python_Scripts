...
import lolcat as lolcat
import pyfiglet


def in_sudo_mode():
    """If the user doesn't run the program with superuser privileges, don't allow them to continue."""
...
def set_into_managed_mode(wifi_name):
    """SET YOUR NETWORK CONTROLLER INTERFACE INTO MANAGED MODE & RESTART NETWORK MANGER
...
pyfiglet.print_figlet("WiFi DoS"|lolcat)
