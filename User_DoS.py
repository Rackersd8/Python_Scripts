...
import time
# Importing figlet module for user interface header.
        ...
        for file_name in os.listdir():
            ...
            for item in active_clients:
                ...
                if item not in threads_started:
                    ...
                    # We run the deauth_attack function in the thread with the arguments hackbssid, item and wifi_name, we also specify it as a background daemon thread.
